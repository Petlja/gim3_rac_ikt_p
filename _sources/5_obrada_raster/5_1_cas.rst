...
Дигиталну слику можеш додатно да уређујеш тако што поред корекције на слици (нивоа осветљености, контраста, обојености, itd.) и примене филтера да би се слика изоштрила, замутила или додали специјални ефекти, можеш да примениш и одређене геометријске трансформације над сликом.
